        ...
        <div className="container-fluid">
            ...
            <div className="col-12 container-fluid">
              <ul className="list-unstyled text-primary row">
                <li className="col d-flex align-items-center">
                  ...
                  <span className="ml-2">+57 (300) 836-1141</span>
                </li>
                <li className="col">
                  <a
                ...
                <li className="col">
                  <a
                    className="d-flex align-items-center"
                    href="https://www.facebook.com/worldsapartorganics/"
                    target="_blank "
                  >
                    <FontAwesomeIcon size="2x" icon={faFacebook} />
                    <span className="ml-2">
                      Worlds apart organics, farm and bed n'breakfast
                    </span>
                  </a>
                </li>
                <li className="col">
                  <a
                    className="d-flex align-items-center"
                    href="https://www.instagram.com/worldsaparthostel/"
                    target="_blank "
                  >
          ...
          <div className="row container-fluid mt-3">
            <div className="row m-0 p-0 contentCopy align-items-center">
              <p className="col-auto m-0">©Copyright 2020</p>
              <div className="col-auto">
                <a href="https://alejandrochvs.com" target="_blank">
                  <img
                    src="https://alejandrochvs.com/assets/logo.png"
                    className="copyright"
                  />
                </a>
              </div>
              <div className="col-auto">
                <a href="http://mariaviiia.com" target="_blank">
                  <img
                    src="http://mariaviiia.com/static/media/LOGO.3db595a5.svg"
                    className="copyright"
                  />
                </a>
              </div>
