...
import ParaglidingImage from '../../assets/img/activities/6.png'
import MountainBikingImage from '../../assets/img/activities/2.jpg'
import WorkshopsImage from '../../assets/img/activities/1.png'
import HorsebackImage from '../../assets/img/activities/4.png'
import CannyoningImage from '../../assets/img/activities/6.jpg'
                ...
                <div className="row align-items-center align-content-center parallax-window">
                    <div className="col-5 text-activities-left">
                        ...
                        <p>We offer several free guided hikes, all within reasonable distance of the farm. The most
                            accessible are
                            the
                            waterfalls and natural swimming pools. Not more than a five minute walk uphill from the
                            lodging
                            facilities
                            ...
                            Hike." About
                            thirty minutes uphill from the farm there is a panela mill or "trapiche." Panela is a
                            product
                            extracted
                            from
                ...
                <div className="row align-items-center align-content-center parallax-window">
                    <div className="col-5 offset-7 text-activities-right">
                        ...
                        <p>From El Alto de Matasanos we offer tandem paragliding. The point of take off has an elevation
                            of
                            approximately 2200m. From there you will glide over the northernmost parts of Barbosa.
                            Emerald
                            green
                            hills
                            segmented by the regions cascading mountain rivers. On a clear day you can even see “El
                            Peñol.”
                            Flight
                            time
                ...
                <div className="row align-items-center align-content-center parallax-window">
                    <div className="col-5 text-activities-left">
                        ...
                        <p>For groups of 2-6 persons we offer the Mocorongo Milk Run. It is roughly ten kilometers of
                            ...
                            natural
                            landscape. It’s cascades and tumbling waters give birth to terraced swimming holes which
                            mark
                            the
                            descending
                            path all the way to Barbosa. We will stop at several points to rest and refresh. One of
                            which
                            will be at
                            the
                            end of trip when we stop at a we’ll know local swimming hole called “La Crypta”(The Crypt).
                            It
                            is.
                            spacious
                ...
                <div className="row align-items-center align-content-center parallax-window">
                    <div className="col-5 offset-7 text-activities-right">
                        ...
                        <p>Our workshops at Wolds Apart can be divided into two categories. Permaculture and
                            ...
                            carpentry or
                            simply enjoy working to help out in many ways. For people looking to be productive during
                            their
                            travels
                ...
                <div className="row align-items-center align-content-center parallax-window">
                    <div className="col-5 text-activities-left">
                        ...
                        <p>In collaboration with some of the local horse stables we organize several guided horseback
                            tours.
                            It is a
                            common and well liked activity for couples and small groups, ranging in time from hourly to
                            all
                            day
                            outings.
