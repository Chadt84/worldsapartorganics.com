  ...
  return (
    <React.Fragment>
      ...
      <div className="container  pt-3">
        <div className="row">
          <p className="col-12 col-sm-6">
            ...
            <br /> +57 (300) 836-1141
            <br />-{" "}
            <a href="mailto:worldsapartorganics@gmail.com ">
              worldsapartorganics@gmail.com
            </a>
            <br />
          </p>
          <p className="col-12 directions d-none">
            <b>Directions</b> <br />
            We are located approximately 45 minutes from Medellin. To get here
            form Medellin, you'll leave the city form Bello, the city's northern
            most quadrant. Head north on route 25, a spacious four; sometimes
            six lane highway. Follow the road signs Barbosa, continuing as if to
            arrive in Bucaramanga in a NNE direction.
          </p>
          <iframe
      ...
      >
        ...
        <p>
          Send an <b className="text-white">e-mail</b>
        </p>
      </button>
    </React.Fragment>
  );
